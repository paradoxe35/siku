...
@section('title', __("Termes et conditions").' | ')
...
<div class="container-fluid">
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or
                &quot;Our&quot; in this Agreement) refers to PNG, KG 345.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to Siku, accessible from <a href="http://www.sikuweb.com"
                    rel="external nofollow noopener" target="_blank">http://www.sikuweb.com</a></p>
        </li>
        <li>
    ...
    <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal
        ...
        browser. You can learn more about cookies here: <a href="https://www.termsfeed.com/blog/cookies/"
            target="_blank">All About Cookies by TermsFeed</a>.</p>
    ...
    <ul>
        <li>By email: siku.png@gmail.com</li>
    </ul>
</div>
@endsection