...
return [
    ...
    */
    ...
    'app_group_chat_id' => env('TELEGRAM_APP_GROUP_CHAT_ID'),

    'app_admin_chat_id' => env('TELEGRAM_APP_ADMIN_CHAT_ID'),
    ...
    */
    'commands' => [
        ...
        \App\Webhooks\Telegram\Commands\StartCommand::class,

        //check
        \App\Webhooks\Telegram\Commands\Check\CheckCommand::class,
        \App\Webhooks\Telegram\Commands\Check\DisconnectCommand::class,
        \App\Webhooks\Telegram\Commands\Check\HelpCommand::class,

        // chat
        \App\Webhooks\Telegram\Commands\Chat\ChatCommand::class,
        \App\Webhooks\Telegram\Commands\Chat\ProfileCommand::class,
        \App\Webhooks\Telegram\Commands\Chat\DisconnectCommand::class,

        //auth
        \App\Webhooks\Telegram\Commands\SessionCommand::class,
    ],
